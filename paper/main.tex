...
For both STEAM and the giga-LES volumes, simulated reflectivity fields are constructed by first computing a three-dimensional optical depth $\tau$ field using the following parameterization, the same used by \citet{dewitt2024}:

From this three-dimensional optical depth field, two-stream albedo is computed using (citation):
