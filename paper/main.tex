...
\cline{1-6}
SAM-GATE & 0.32 & 1.68 & 1.50 & -- & -- \\
SAM-TWPICE & 0.96 & 1.43 & -- & -- & -- \\
STEAM $c = 0.05$ & 0.48 & 1.67 & -- & 0.67 & 1.10 \\
STEAM $c = 0.17$ & --& --& --& \textbf{0.78} & --\\
\middlehline
\multicolumn{6}{l}{\textbf{$R > 0.2$}} \\
MODIS & 0.41 & 1.75 & 1.40 & 0.88 & 1.28 \\
\cline{1-6}
SAM-GATE & 0.24 & 1.63 & 1.29 & -- & ---- \\
SAM-TWPICE & 0.81 & 1.56 & \textbf{1.45} & -- & -- \\
...
SAM-TWPICE & 0.63 & 1.61 & \textbf{1.36} & -- & -- \\
...
The calculated values of the geometric exponents are shown in Table \ref{tab:cloud geometry}
